...
const elements = {
  ...
  rawWpmElem: document.getElementById("rawWpm"),
  accuracyElem: document.getElementById("accuracy"),
  errorsElem: document.getElementById("errors"),
  charPerSecElem: document.getElementById("charPerSec"),
...
function updateQuoteCountDisplay() {
  const count = QUOTES_LIB[quoteSource]?.[difficulty]?.length || 20;
...
function updateQuoteUI() {
  ...
  elements.difficultyBadge.className = `difficulty-badge difficulty-${difficulty === "expert" ? "hard" : difficulty}`;
...
function resetTestState() {
  ...
  elements.rawWpmElem.innerText = "0";
  elements.accuracyElem.innerText = "0%";
  elements.errorsElem.innerText = "0";
  elements.charPerSecElem.innerText = "0";
